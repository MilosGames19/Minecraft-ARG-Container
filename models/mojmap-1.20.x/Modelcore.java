...
public class Modelcore<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "core"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(196, 97)
		...
		PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-43.5F, -5.0F, -43.5F, 11.0F, 10.0F, 87.0F, new CubeDeformation(0.0F)).texOffs(0, 97)
						.addBox(32.5F, -5.0F, -43.5F, 11.0F, 10.0F, 87.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, -2.0F, -0.5F));

		PartDefinition cube_r1 = bone2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(196, 268).addBox(13.0F, -10.0F, -20.0F, 11.0F, 10.0F, 65.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(12.5F, 5.0F, 19.5F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(196, 193).addBox(13.0F, -10.0F, -20.0F, 11.0F, 10.0F, 65.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(12.5F, 5.0F, -56.5F, 0.0F, -1.5708F, 0.0F));

		PartDefinition bone3 = partdefinition.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(0, 194)
						.addBox(-43.5F, -5.0F, -43.5F, 11.0F, 10.0F, 87.0F, new CubeDeformation(0.0F)).texOffs(196, 0)
						.addBox(32.5F, -5.0F, -43.5F, 11.0F, 10.0F, 87.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -2.0F, -0.5F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r3 = bone3.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(152, 343).addBox(13.0F, -10.0F, -20.0F, 11.0F, 10.0F, 65.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(12.5F, 5.0F, 19.5F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r4 = bone3.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 291).addBox(13.0F, -10.0F, -20.0F, 11.0F, 10.0F, 65.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(12.5F, 5.0F, -56.5F, 0.0F, -1.5708F, 0.0F));
