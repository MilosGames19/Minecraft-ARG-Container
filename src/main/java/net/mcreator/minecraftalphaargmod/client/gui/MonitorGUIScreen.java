...
public class MonitorGUIScreen extends AbstractContainerScreen<MonitorGUIMenu> implements WidgetScreen {
	...
	private static final ResourceLocation texture = new ResourceLocation("the_arg_container:textures/screens/monitor_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.the_arg_container.monitor_gui.label_monitor"), 3, -7, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.the_arg_container.monitor_gui.button_empty"), e -> {
			if (true) {
				TheArgContainerMod.PACKET_HANDLER.sendToServer(new MonitorGUIButtonMessage(0, x, y, z, textstate));
		...
		button_empty1 = Button.builder(Component.translatable("gui.the_arg_container.monitor_gui.button_empty1"), e -> {
			if (true) {
				TheArgContainerMod.PACKET_HANDLER.sendToServer(new MonitorGUIButtonMessage(1, x, y, z, textstate));
		...
		button_empty2 = Button.builder(Component.translatable("gui.the_arg_container.monitor_gui.button_empty2"), e -> {
			if (true) {
				TheArgContainerMod.PACKET_HANDLER.sendToServer(new MonitorGUIButtonMessage(2, x, y, z, textstate));
		...
		button_ps = Button.builder(Component.translatable("gui.the_arg_container.monitor_gui.button_ps"), e -> {
			if (true) {
				TheArgContainerMod.PACKET_HANDLER.sendToServer(new MonitorGUIButtonMessage(3, x, y, z, textstate));
		...
		button_off = Button.builder(Component.translatable("gui.the_arg_container.monitor_gui.button_off"), e -> {
			if (true) {
				TheArgContainerMod.PACKET_HANDLER.sendToServer(new MonitorGUIButtonMessage(4, x, y, z, textstate));
