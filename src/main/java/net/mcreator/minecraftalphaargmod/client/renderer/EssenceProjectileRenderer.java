...
public class EssenceProjectileRenderer extends EntityRenderer<EssenceProjectileEntity> {
	...
	@Override
	public void render(EssenceProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(EssenceProjectileEntity entity) {
		return texture;
	}
}
