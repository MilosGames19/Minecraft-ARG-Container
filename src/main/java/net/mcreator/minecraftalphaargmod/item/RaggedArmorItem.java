...
public abstract class RaggedArmorItem extends ArmorItem {
	...
	public static class Helmet extends RaggedArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends RaggedArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends RaggedArmorItem {
		public Leggings() {
	...
	public static class Boots extends RaggedArmorItem {
		public Boots() {
