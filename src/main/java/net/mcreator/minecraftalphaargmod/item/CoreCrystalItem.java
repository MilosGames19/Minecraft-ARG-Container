...
import net.mcreator.minecraftalphaargmod.procedures.CoreCrystalLivingEntityIsHitWithItemProcedure;

import java.util.List;

public class CoreCrystalItem extends Item {
	public CoreCrystalItem() {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		CoreCrystalLivingEntityIsHitWithItemProcedure.execute(entity.level(), entity);
		return retval;
	}
}
