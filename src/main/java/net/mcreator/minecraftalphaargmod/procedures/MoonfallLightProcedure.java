...
public class MoonfallLightProcedure {
	...
	public static void setBlockColor(float level, int blockColor) {
		MoonfallLightProcedure.blockLevel = Mth.clamp(level, 0.0F, 1.0F);
		MoonfallLightProcedure.blockColor = new Vector3f((blockColor >> 16 & 255) / 255.0F, (blockColor >> 8 & 255) / 255.0F, (blockColor & 255) / 255.0F);
	}
	...
	public static void setSkyColor(float level, int skyColor) {
		MoonfallLightProcedure.skyLevel = Mth.clamp(level, 0.0F, 1.0F);
		MoonfallLightProcedure.skyColor = new Vector3f((skyColor >> 16 & 255) / 255.0F, (skyColor >> 8 & 255) / 255.0F, (skyColor & 255) / 255.0F);
	}
