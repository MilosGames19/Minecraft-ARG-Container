...
public class ClothPanelOnBlockRightClickedProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BLACK_DYE) {
			...
			world.setBlock(BlockPos.containing(x, y, z), MinecraftAlphaArgModModBlocks.BLACK_CLOTH_PANEL.get().defaultBlockState(), 3);
			...
			world.setBlock(BlockPos.containing(x, y, z), MinecraftAlphaArgModModBlocks.BLUE_CLOTH_PANEL.get().defaultBlockState(), 3);
			...
			world.setBlock(BlockPos.containing(x, y, z), MinecraftAlphaArgModModBlocks.GREEN_CLOTH_PANEL.get().defaultBlockState(), 3);
			...
			world.setBlock(BlockPos.containing(x, y, z), MinecraftAlphaArgModModBlocks.MAGENTA_CLOTH_PANEL.get().defaultBlockState(), 3);
			...
			world.setBlock(BlockPos.containing(x, y, z), MinecraftAlphaArgModModBlocks.CLOTH_PANEL.get().defaultBlockState(), 3);
		} else {
			return true;
		}
		return false;
