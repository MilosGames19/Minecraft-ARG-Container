...
public class HubSkyFiveRender implements BlockEntityRenderer<HubSkyFiveBlockEntity> {
  @Override
  public void render(HubSkyFiveBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
   ...
   public static RenderType getRenderType() {
        RenderStateShard.ShaderStateShard shaderState = new RenderStateShard.ShaderStateShard(ShardsHandler::GetPlaneImage);
            ...
            ResourceLocation OVERLAY = new ResourceLocation("the_arg_container", "textures/hub_parallax1_sq.png");
