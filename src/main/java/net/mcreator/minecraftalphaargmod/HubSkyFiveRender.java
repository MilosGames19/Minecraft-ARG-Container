...
public class HubSkyFiveRender implements BlockEntityRenderer<HubSkyFiveBlockEntity> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation("the_arg_container", "textures/hub_parallax1_sq.png");

    private static VertexBuffer cubeBuffer;

    @Override
    public void render(HubSkyFiveBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
