...
public class HubSkyThreeRender implements BlockEntityRenderer<HubSkyThreeBlockEntity> {
  @Override
  public void render(HubSkyThreeBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
   ...
   public static RenderType getRenderType() {
        RenderStateShard.ShaderStateShard shaderState = new RenderStateShard.ShaderStateShard(ShardsHandler::GetPlaneImage);
            ...
            ResourceLocation OVERLAY = new ResourceLocation("the_arg_container", "textures/internal_footage_2_sky.png");
