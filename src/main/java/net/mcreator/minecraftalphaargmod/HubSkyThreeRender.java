...
public class HubSkyThreeRender implements BlockEntityRenderer<HubSkyThreeBlockEntity> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation("the_arg_container", "textures/internal_footage_2_sky.png");

    private static VertexBuffer cubeBuffer;

    @Override
    public void render(HubSkyThreeBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
