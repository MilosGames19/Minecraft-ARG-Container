...
public class PaletteKeyHandler {
	...
	public static final KeyMapping PALETTE_KEY = new KeyMapping("key.the_arg_container.palette", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_V, "key.categories.misc");
