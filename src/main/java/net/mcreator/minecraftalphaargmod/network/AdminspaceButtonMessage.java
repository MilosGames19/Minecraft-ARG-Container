...
public class AdminspaceButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public AdminspaceButtonMessage(FriendlyByteBuf buffer) {
	...
	public AdminspaceButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(AdminspaceButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(AdminspaceButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = AdminspaceMenu.guistate;
		...
		if (buttonID == 0) {
			...
			OpenCOMANDProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {
