...
public class TheUltimateTruthBricksRender implements BlockEntityRenderer<TheUltimateTruthBricksBlockEntity> {
  @Override
  public void render(TheUltimateTruthBricksBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
    ...
    private static void renderCube(Matrix4f p_173692_, VertexConsumer p_173693_) {
      renderFace(p_173692_, p_173693_, 0.0F, 1.0F, 0.0F, 1.0F, 0.999F, 0.999F, 0.999F, 0.999F); //South 
      renderFace(p_173692_, p_173693_, 0.0F, 1.0F, 1.0F, 0.0F, 0.001F, 0.001F, 0.001F, 0.001F); //North
      renderFace(p_173692_, p_173693_, 0.999F, 0.999F, 1.0F, 0.0F, 0.0F, 0.999F, 0.999F, 0.0F); //East
      renderFace(p_173692_, p_173693_, 0.001F, 0.001F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F); // West
      renderFace(p_173692_, p_173693_, 0.0F, 1.0F, 0.001F, 0.001F, 0.0F, 0.0F, 1.0F, 1.0F); //Bottom
      renderFace(p_173692_, p_173693_, 0.0F, 1.0F, 0.999F, 0.999F, 1.0F, 1.0F, 0.0F, 0.0F); //Top
   }
