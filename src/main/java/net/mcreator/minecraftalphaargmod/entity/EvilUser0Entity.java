...
public class EvilUser0Entity extends Monster {
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		EvilUser0EntityIsHurtProcedure.execute(world, sourceentity);
	...
	public void die(DamageSource source) {
		super.die(source);
		EvilUser0EntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata, tag);
		EvilUser0OnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
