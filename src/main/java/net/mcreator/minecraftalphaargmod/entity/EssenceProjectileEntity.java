...
public class EssenceProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public EssenceProjectileEntity(EntityType<? extends EssenceProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public EssenceProjectileEntity(EntityType<? extends EssenceProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		EssenceProjectileProjectileHitsLivingEntityProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static EssenceProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 2f, 4, 4);
	}
