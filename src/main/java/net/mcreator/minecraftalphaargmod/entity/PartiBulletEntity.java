...
public class PartiBulletEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(TheArgContainerModItems.TESTER_BULLET.get());

	public PartiBulletEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TheArgContainerModEntities.PARTI_BULLET.get(), world);
	}

	public PartiBulletEntity(EntityType<? extends PartiBulletEntity> type, Level world) {
		super(type, world);
	}

	public PartiBulletEntity(EntityType<? extends PartiBulletEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public PartiBulletEntity(EntityType<? extends PartiBulletEntity> type, LivingEntity entity, Level world) {
	...
	public static PartiBulletEntity shoot(Level world, LivingEntity entity, RandomSource source) {
	...
	public static PartiBulletEntity shoot(LivingEntity entity, LivingEntity target) {
		PartiBulletEntity entityarrow = new PartiBulletEntity(TheArgContainerModEntities.PARTI_BULLET.get(), entity, entity.level());
