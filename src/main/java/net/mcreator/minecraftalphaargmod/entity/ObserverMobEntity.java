...
public class ObserverMobEntity extends Monster {
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("the_arg_container:obvr_attack"));
	}
	...
	public static void init() {
		...
		DungeonHooks.addDungeonMob(TheArgContainerModEntities.OBSERVER_MOB.get(), 180);
	}
