...
public class LongLegsEntity extends Monster {
	public LongLegsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheArgContainerModEntities.LONG_LEGS.get(), world);
	}

	public LongLegsEntity(EntityType<LongLegsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 90;
		setNoAi(false);
