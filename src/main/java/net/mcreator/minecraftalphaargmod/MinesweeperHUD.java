...
public class MinesweeperHUD {
    ...
    // ------------------------------------------------------------------
    // Decide whether the HUD should be visible right now
    // ------------------------------------------------------------------

    private static boolean shouldRenderHud() {
        if (!ClientBoardCache.hasBoard()) return false;
    ...
    // ------------------------------------------------------------------
    // Suppress vanilla HUD while minesweeper HUD is active
    // ------------------------------------------------------------------
    ...
    private static void renderHudElements(GuiGraphics gui, int sw, int sh, Minecraft mc) {
        ...
        // --- Game Over / Victory banner (centred) ---
        if (ClientBoardCache.isGameOver()) {
    ...
    private static void renderBox(GuiGraphics gui, int x, int y, int w, int h,
                                  int bg, int borderStart, int borderEnd) {
