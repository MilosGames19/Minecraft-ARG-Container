...
public class HubSkyRender implements BlockEntityRenderer<HubSkyBlockEntity> {
  @Override
  public void render(HubSkyBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
