...
public class ShatteredSkyboxNightBlockRender implements BlockEntityRenderer<MoonfallSkyBlockNightBlockEntity> {
    ...
    @Override
    public void render(MoonfallSkyBlockNightBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
