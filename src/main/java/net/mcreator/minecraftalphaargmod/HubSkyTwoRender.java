...
public class HubSkyTwoRender implements BlockEntityRenderer<HubSkyTwoBlockEntity> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation("the_arg_container", "textures/internal_footage_sky.png");

    private static VertexBuffer cubeBuffer;

    @Override
    public void render(HubSkyTwoBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
