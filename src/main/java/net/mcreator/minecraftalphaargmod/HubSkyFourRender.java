...
public class HubSkyFourRender implements BlockEntityRenderer<HubSkyFourBlockEntity> {
  @Override
  public void render(HubSkyFourBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
   ...
   public static RenderType getRenderType() {
        RenderStateShard.ShaderStateShard shaderState = new RenderStateShard.ShaderStateShard(ShardsHandler::GetPlaneImage);
            ...
            ResourceLocation OVERLAY = new ResourceLocation("the_arg_container", "textures/para2.png");
