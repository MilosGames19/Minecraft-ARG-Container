...
public class PolishedToughFenceBlock extends FenceBlock {
	public PolishedToughFenceBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM)
				...
				.strength(1.4f, 10f).requiresCorrectToolForDrops().dynamicShape().forceSolidOn());
	}
}
