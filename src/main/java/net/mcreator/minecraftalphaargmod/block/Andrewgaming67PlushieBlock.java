...
import net.mcreator.minecraftalphaargmod.procedures.Andrewgaming67PlushieBlockIsPlacedByProcedure;

public class Andrewgaming67PlushieBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public Andrewgaming67PlushieBlock() {
	...
	public void setPlacedBy(Level world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
		...
		Andrewgaming67PlushieBlockIsPlacedByProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
	}
}
