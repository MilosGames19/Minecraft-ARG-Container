...
import net.mcreator.minecraftalphaargmod.procedures.HubDoorEntityCollidesInTheBlockProcedure;
...
public class HubDoorBlock extends DoorBlock {
	...
	public void entityInside(BlockState blockstate, Level world, BlockPos pos, Entity entity) {
		...
		HubDoorEntityCollidesInTheBlockProcedure.execute(world, entity);
	}
}
