...
import net.mcreator.minecraftalphaargmod.procedures.AuthorPlushieBlockIsPlacedByProcedure;

public class AuthorPlushieBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public AuthorPlushieBlock() {
	...
	public void setPlacedBy(Level world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
		...
		AuthorPlushieBlockIsPlacedByProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
	}
}
