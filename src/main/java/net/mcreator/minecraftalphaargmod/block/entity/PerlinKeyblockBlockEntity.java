...
public class PerlinKeyblockBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("perlin_keyblock");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new Key1Menu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
