...
public class PolishedToughFence1Block extends FenceBlock {
	public PolishedToughFence1Block() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM)
				...
				.strength(1f, 10f).requiresCorrectToolForDrops().dynamicShape().forceSolidOn());
	}
}
