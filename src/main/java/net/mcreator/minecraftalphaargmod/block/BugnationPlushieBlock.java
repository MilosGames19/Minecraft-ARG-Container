...
import net.mcreator.minecraftalphaargmod.procedures.BugnationPlushieBlockIsPlacedByProcedure;

public class BugnationPlushieBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public BugnationPlushieBlock() {
	...
	public void setPlacedBy(Level world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
		...
		BugnationPlushieBlockIsPlacedByProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
	}
}
