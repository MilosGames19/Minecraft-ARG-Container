...
import net.mcreator.minecraftalphaargmod.procedures.LimestoneBlockDestroyedByPlayerProcedure;
...
public class LimestoneBlock extends Block {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		LimestoneBlockDestroyedByPlayerProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
		return retval;
	}
}
