...
import net.mcreator.minecraftalphaargmod.block.PurpleLogBlock;
...
public class MinecraftAlphaArgModModBlocks {
	public static final DeferredRegister<Block> REGISTRY = DeferredRegister.create(ForgeRegistries.BLOCKS, MinecraftAlphaArgModMod.MODID);
	...
	public static final RegistryObject<Block> SOUL_COBBLESOTNE = REGISTRY.register("soul_cobblesotne", () -> new SoulCobblesotneBlock());
