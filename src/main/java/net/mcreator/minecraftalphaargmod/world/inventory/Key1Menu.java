...
public class Key1Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Key1Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinecraftAlphaArgModModMenus.KEY_1.get(), id);
