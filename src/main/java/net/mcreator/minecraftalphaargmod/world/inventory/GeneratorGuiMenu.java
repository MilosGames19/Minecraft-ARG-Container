...
public class GeneratorGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GeneratorGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheArgContainerModMenus.GENERATOR_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 26, 29) {
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 44, 29) {
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 80, 29) {
